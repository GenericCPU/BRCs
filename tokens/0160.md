...
This BRC defines how **inscriptions** attach content to a [BRC-159](./0159.md) token: an `ord` **envelope** embedded in the locking script of a **1-satoshi** output.
...
See [BRC-159](./0159.md) for origin, sat ordering, and transfer.
...
* Chain identity (origin and transfers) is unchanged by envelopes — see [BRC-159](./0159.md).
...
Because envelopes live in **outputs** (not input witnesses), an inscription is identified by the outpoint of the output that carries it. Outpoint string forms follow [BRC-159](./0159.md) (underscore or dot; both denote the same outpoint).
...
Transfers afterward follow [BRC-159](./0159.md) (1-satoshi input → 1-satoshi output under sat ordering). The envelope does not need to be repeated on every output in the chain unless the application re-inscribes.
...
* Wallet baskets, tags, or provenance proofs — [BRC-147](./0147.md), [BRC-150](./0150.md)
* Marketplaces and application-specific locks

Those may require [BRC-159](./0159.md), this envelope BRC, or both.
...
1. [BRC-159: 1Sat Ordinals — Single-Satoshi Tokens and Origin Tracking](./0159.md)
2. [BRC-147](./0147.md) — 1Sat Ordinals Basket Profile for BRC-46 / BRC-100
3. [BRC-150](./0150.md) — 1Sat Provenance Remittance for Basket `1sat`
