# BRC-222: Subtree Data Frame Format
...
identifying root must travel **in-band**. BRC-222 is that frame — the merkle
...
transaction feed or fetched out of band. BRC-222 proper is hashes-only.
