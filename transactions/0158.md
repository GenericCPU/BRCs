...
| BEEF | variable | [BRC-96](./0096.md) BEEF V2 structure (`0x0200beef` …), or [BRC-62](./0062.md) BEEF V1 if V2 is unavailable |

The prefix is the same width as the Atomic BEEF prefix (`0x01010101`). The
subject is 36 bytes (outpoint) instead of 32 (txid only). The embedded BEEF
SHOULD be **V2** (`0200BEEF` / [BRC-96](./0096.md)).
...
2. BEEF MUST parse as BEEF V2 ([BRC-96](./0096.md)) or BEEF V1 ([BRC-62](./0062.md)) and pass structural validation. Implementations SHOULD produce V2.
3. The subject outpoint’s transaction MUST be present in the BEEF (not merely as a txid-only stub unless the verifier already trusts that tx by other means per BRC-96).
...
1. [BRC-62](./0062.md) — Background Evaluation Extended Format (BEEF) V1
2. [BRC-96](./0096.md) — BEEF V2, Txid Only Extension
3. [BRC-95](./0095.md) — Atomic BEEF Transactions
4. [BRC-67](./0067.md) — Simplified Payment Verification
5. [BRC-150](../tokens/0150.md) — 1Sat Provenance Remittance (Brandon Cryderman / HandCash)
6. [BRC-147](../tokens/0147.md) — 1Sat Ordinals Basket Profile
7. 1Sat Ordinals — <https://docs.1satordinals.com>
